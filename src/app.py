...
activities = {
    ...
    "Soccer Training": {
        "description": "Practice ball control and team tactics for soccer",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["nina@mergington.edu", "carlos@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim laps and develop competitive swimming skills",
    ...
    "Drama Club": {
        "description": "Practice acting, scene work, and stagecraft for performances",
